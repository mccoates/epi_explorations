...
-   Talking to professor in Bayesian analysis class who strongly preferred a difference in differences approach with an individual-level random effect over an approach estimating the outcome at time 2, using the outcome at time 1 as a predictor

# Aim
Compare multiple strategies for analyzing simulated RCT data to understand differences that can arise in estimates between models across different types of data generating processes.
