...
(3) $Y = \alpha_0 + \alpha_{Arm} Arm + \alpha_{Post} Post + \alpha_{Arm*Post} Arm*Post + \epsilon$

(4) $Y = \alpha_0 + \alpha_{Arm} Arm + \alpha_{Post} Post + \alpha_{Arm*Post} Arm*Post + \gamma + \epsilon$

where $Arm$ is treatment an indicator of the study arm, $Post$ is an indicator of time (pre/post intervention), and $\gamma$ is an individual-specific random effect.


**NOTE TO RENAME PARAMETERS ABOVE TO DIFFER**
...
<!-- -->
```
(a) Unsaturated $Y_t=\beta_0 + \beta_X X + \beta_{Y_0} Y_0 + \epsilon$
(b) Saturated $Y_t=\beta_0 + \beta_X X + \beta_{Y_0} Y_0 + \beta_{X*Y_0} X*Y_0 + \epsilon$
...
(a) No Individual Random Effect $Y_t=\beta_0 + \beta_X X + \beta_{time} time + \beta_{time*X} time*X + \epsilon$
(b) Individual Random Effect $Y_t=\beta_0 + \beta_X X + \beta_{time} time + \beta_{time*X} time*X + \gamma + \epsilon$

**NOTE TO REWRITE THESE USING SAME NOTATION AS FOR DATA GENERATION ABOVE**
